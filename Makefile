...
deploy-all: deploy-symbiotic-core deploy-collateral deploy-vault deploy-operator-reward deploy-staker-reward deploy-validation-service-manager ## Deploy all contracts
