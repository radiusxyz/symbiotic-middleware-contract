...
cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $WBTC_ACCOUNT_ADDRESS
cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $STETH_ACCOUNT_ADDRESS


cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $DEFAULT_OPERATOR_ADDRESS 
cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $WBTC_OPERATOR_ADDRESS
cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $STETH_OPERATOR_ADDRESS

cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $WBTC_OPERATOR_ADDRESS_SECONDARY
cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 1ether $STETH_OPERATOR_ADDRESS_SECONDARY


# # WBTC Token Setup
cast send $WBTC_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $TOKEN_CONTRACT_OWNER_PRIVATE_KEY \
"transfer(address,uint256)" $WBTC_ACCOUNT_ADDRESS 15000

cast call $WBTC_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL \
"balanceOf(address)(uint256)" $WBTC_ACCOUNT_ADDRESS

cast send $WBTC_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_ACCOUNT_PRIVATE_KEY \
...
cast send $WBTC_COLLATERAL_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_ACCOUNT_PRIVATE_KEY \
...
cast send $WBTC_VAULT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_ACCOUNT_PRIVATE_KEY \
"deposit(address onBehalfOf, uint256 amount)(uint256 depositedAmount, uint256 mintedShares)" $WBTC_ACCOUNT_ADDRESS 15000

cast call $WBTC_VAULT_ADDRESS --rpc-url $LIVENESS_RPC_URL \
...
# Register Operators
cast send $OPERATOR_REGISTRY_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY \
"registerOperator()"

cast send $OPERATOR_REGISTRY_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY \
"registerOperator()"

cast send $OPERATOR_REGISTRY_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY \
"registerOperator()"
...
cast send $OPERATOR_REGISTRY_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY_SECONDARY \
"registerOperator()"

cast send $OPERATOR_REGISTRY_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY_SECONDARY \
"registerOperator()"
...
cast send $OPERATOR_NETWORK_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY \
"optIn(address network)" $NETWORK_ADDRESS

cast send $OPERATOR_NETWORK_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY \
"optIn(address network)" $NETWORK_ADDRESS

cast send $OPERATOR_NETWORK_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY \
"optIn(address network)" $NETWORK_ADDRESS
...
cast send $OPERATOR_NETWORK_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY_SECONDARY \
"optIn(address network)" $NETWORK_ADDRESS

cast send $OPERATOR_NETWORK_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY_SECONDARY \
"optIn(address network)" $NETWORK_ADDRESS
...
cast send $OPERATOR_VAULT_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY \
"optIn(address vault)" $WBTC_VAULT_ADDRESS

cast send $OPERATOR_VAULT_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY \
"optIn(address vault)" $WBTC_VAULT_ADDRESS

cast send $OPERATOR_VAULT_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY \
"optIn(address vault)" $STETH_VAULT_ADDRESS

# Secondary Operator Vault Opt-In

cast send $OPERATOR_VAULT_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY_SECONDARY \
"optIn(address vault)" $WBTC_VAULT_ADDRESS

cast send $OPERATOR_VAULT_OPT_IN_SERVICE_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY_SECONDARY \
"optIn(address vault)" $STETH_VAULT_ADDRESS
...
# # WBTC Delegator
cast send $WBTC_DELEGATOR_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY \
"setMaxNetworkLimit(uint96 identifier, uint256 amount)" 0 10000

cast send $WBTC_DELEGATOR_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $VAULT_OWNER_PRIVATE_KEY \
...
# # Register Sequencers
cast send $LIVENESS_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY \
"registerTxOrderer(string clusterId)" $CLUSTER_ID

cast send $LIVENESS_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY \
"registerTxOrderer(string clusterId)" $CLUSTER_ID

cast send $LIVENESS_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY \
"registerTxOrderer(string clusterId)" $CLUSTER_ID

cast send $LIVENESS_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $WBTC_OPERATOR_PRIVATE_KEY_SECONDARY \
"registerTxOrderer(string clusterId)" $CLUSTER_ID

cast send $LIVENESS_CONTRACT_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $STETH_OPERATOR_PRIVATE_KEY_SECONDARY \
"registerTxOrderer(string clusterId)" $CLUSTER_ID

# # # Setup Rewards
cast send $REWARDS_CORE_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY \
...
# cast send $DEFAULT_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY \
...
# cast send $WBTC_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY \
# "approve(address,uint256)" $REWARDS_CORE_ADDRESS 50000000000000000000

# cast send $STETH_TOKEN_ADDRESS --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY \
# "approve(address,uint256)" $REWARDS_CORE_ADDRESS 50000000000000000000
...
# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $WBTC_ACCOUNT_ADDRESS
# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $STETH_ACCOUNT_ADDRESS


# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $DEFAULT_OPERATOR_ADDRESS 
# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $WBTC_OPERATOR_ADDRESS
# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $STETH_OPERATOR_ADDRESS

# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $WBTC_OPERATOR_ADDRESS_SECONDARY
# cast send --rpc-url $LIVENESS_RPC_URL --private-key $PRIVATE_KEY --value 0.5ether $STETH_OPERATOR_ADDRESS_SECONDARY


# cast send $VALIDATION_SERVICE_MANAGER_CONTRACT_ADDRESS "createNewTask(string,string,uint256,bytes32,address[],bytes32[],uint256[],uint256[])" $CLUSTER_ID $ROLLUP_ID 12 0x287b58b93ed6c17ace087bb87f611bf21102c0602b0956736b6e523fb41c328d [] [] [] [] --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY
...
#         "([],[],[],[])" \
#         --rpc-url $LIVENESS_RPC_URL --private-key $DEFAULT_OPERATOR_PRIVATE_KEY