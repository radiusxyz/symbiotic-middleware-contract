...
# --rpc-url $LIVENESS_RPC_URL --private-key $RADIUS_PRIVATE_KEY --broadcast -vvvv

# # Deploy Collateral
# forge script script/deploy/holesky/CollateralHoleskyDeploy.sol:CollateralHoleskyDeploy \
# --rpc-url $LIVENESS_RPC_URL --private-key $COLLATERAL_OWNER_PRIVATE_KEY --broadcast -vvvv

# # Deploy Vault (for testing)
# forge script script/deploy/holesky/VaultHoleskyDeploy.sol:VaultHoleskyDeploy \
# --rpc-url $LIVENESS_RPC_URL --private-key $VAULT_OWNER_PRIVATE_KEY --broadcast -vvvv
...
# --rpc-url $LIVENESS_RPC_URL --private-key $NETWORK_PRIVATE_KEY --broadcast -vvvv